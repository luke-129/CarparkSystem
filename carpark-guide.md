...
![Initial commit](documentation\initial_commit.PNG)
...
| ---------- |-------------------------------------------|----------------------------------------------------|
| `CarPark`    | Available bays, empty/full, fee, location | update_available_bays,  update_feegi               |
| `Sensor`     | Temperature,  number_plates               | scan_plate, update_temperature                     |
| `Display`    | information, community_message            | update_information, update_message, delete_message |
...
![Added stubs for classes](documentation/screenshots/initial_base_classes.PNG)
...
![tags](documentation/screenshots/tagss1s2.PNG)
...
> 
>The carpark is responsible as the car park is the object that has the capacity attribute. Also without a car park there would be no bays?  
> 
>Q. Which class is responsible for the current temperature (and why)?
> 
>The sensor as generally, sensors will measure the temperature.
> 
>Q. Which class is responsible for the time (and why)?
> 
>The display, no other components like the car park or sensor are required to gather information for the time. The display can just simply display the time. 
--------
...
1. Add a screenshot of the output of the unit tests. If any failed, add a screenshot of the error message and a screenshot after you have fixed the errors:
   ...
   ![Unit tests](documentation/screenshots/car_park_unit_tests.PNG)
...
1. Add a screenshot of the output of the unit tests. If any failed, add a screenshot of the error message and a screenshot after you have fixed the errors:
   ...
   ![Unit tests](documentation/screenshots/test_message_fail.PNG)
   
   ![Unit tests](documentation/screenshots/test_message_succeed.PNG)
...
> The register method is within the car_park class so I would create unit tests within the test_car_park. There are sensors and displays lists for each instance of a car park so it
> would make sense to test within car park to ensure the correct components are being registered. 
...
![Added methods to the car park class](documentation/screenshots/json_config.PNG)
...
1. Add a screenshot of the output of the `main.py` file:
   ...
   ![Main.py output](documentation/screenshots/main.PNG)
